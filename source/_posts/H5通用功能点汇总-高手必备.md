...
于是，有了这么一个图片压缩的工具`imageMin`，及其webpack的扩展<u>[imagemin-webpack-plugin](https://github.com/Klathmon/imagemin-webpack-plugin)</u>。
...
```
亲测实用，`image`文件夹原本5mb(已被tinypng压缩)，打包后只有3.5mb。
